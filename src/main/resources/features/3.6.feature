...
#    Then Verify that quiz "Testing Igor" appears in List of Quizzes
#
#  You need to add steps to delete this quiz to your scenario.
#
#  Status "In Progress". When you will add steps, you can put to "Done"
#
